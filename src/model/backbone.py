...
class Backbone(nn.Module):
    def __init__(self, args, mode='rgbd'):
        ...
        self.litemono = LiteMono(model=args.litemono_model,drop_path_rate=args.drop_path,
                                width=args.width, height=args.height,
                                 pretrained='./pretrained/pvt.pth',)
    ...
    def forward(self, rgb=None, depth=None):
        ...
        # change this part to MonoLite Encoder
        fe2, fe3, fe4, fe5, fe6, fe7 = self.litemono(fe1)
        # Shared Decoding
        fd6 = self.dec6(fe7)
