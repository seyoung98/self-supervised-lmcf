...
def feature_match(img1, img2):
   ...
   '''
    ...
    # Patch size가 작기 때문에 matches가 2개가 안나올 수 있음.
    good = []
    pts1 = []
    pts2 = []
    ...
    try:
        ...
        selected_m = [m[0] for m in matches][min_idx]
        good.append(selected_m)
        pts2.append(kp2[selected_m.trainIdx].pt)
        pts1.append(kp1[selected_m.queryIdx].pt)
