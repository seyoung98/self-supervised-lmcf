...
import time
import argparse
from loss.submodule import criteria
...
parser.add_argument('--loss',
                    type=str,
                    default='1.0*Depth+0.1*Photometric+0.1*Smoothness',
                    # default='1.0*Depth+0.1*Smoothness',
